package com.example.myhouse.DataLocal;
...
public class DataLocalManager {
    ...
    public static void setIntData(String key, int data) {
        DataLocalManager.getInstance().mySharedPreference.putIntValue(key, data);
    }

    public static int getIntData(String key) {
        return DataLocalManager.getInstance().mySharedPreference.getIntValue(key);
    }
