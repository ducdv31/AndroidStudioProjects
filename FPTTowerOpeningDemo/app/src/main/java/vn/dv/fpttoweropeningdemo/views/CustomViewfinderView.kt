...
class CustomViewfinderView constructor(context: Context?, attrs: AttributeSet?) :
    ...
    override fun onDraw(canvas: Canvas?) {
        ...
        canvas?.let { canvas ->
            if (resultBitmap != null) {
                ...
                val scaleX: Float = frame.width().toFloat() / previewFrame.width
                val scaleY: Float = frame.height().toFloat() / previewFrame.height
