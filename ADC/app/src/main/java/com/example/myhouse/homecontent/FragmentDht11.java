...
public class FragmentDht11 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        lineChart = dht11View.findViewById(R.id.chartDht11);
        ...
        Temp = (ArcGauge) dht11View.findViewById(R.id.temperature);
        Temp.setValueColor(Color.BLACK);
        Temp.addRange(Temperature);
        Humi = (ArcGauge) dht11View.findViewById(R.id.humidity);
